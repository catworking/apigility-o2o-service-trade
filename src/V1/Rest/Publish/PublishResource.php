...
class PublishResource extends AbstractResourceListener
{
    /**
    ...
    {
        try {
            return new PublishEntity($this->publishService->getPublish($id));
    ...
    {
        try {
            return new PublishCollection($this->publishService->getPublishes($params));
        } catch (\Exception $exception) {
            return new ApiProblem($exception->getCode(), $exception->getMessage());
        }
    }
